...
public class BillboardCreator : MonoBehaviour
{
    ...
    */
    ...
    IEnumerator ConvertToImage()
    {
        ...
        cam.transform.position.Set(cam.transform.position.x, cam.transform.position.y, -10.0f);
        ...
        cam.transform.position.Set(cam.transform.position.x, cam.orthographicSize * 0.05f, cam.transform.position.z);
